...
from apis_ontology.models import Work, Expression, Person, Organisation, Place, Type
...
def create_source(
    ...
    """
    Helper function for creating a Source object by which
    ...
    :param name: base name of import source,
                 used for Source "orig_filename" field
    :param separator: word separator
    :param metadata: should hold more information about import source, defaults
                     to name of calling script if not provided; used for Source
                     "pubinfo" field
    :param author: used for Source "author" field
    :param with_date: boolean, determines if datetime of import script
                      execution should be appended to Source name
    :return:
    """
...
def create_work(title: str, siglum: str, source: Source):
    """
    ...
    :param source: Source object to link to, used to identify data imports
    :return: Work object
    """
...
def get_type(title: str):
    """
    :return: (Work) Type object or None
    """
    work_type = None
...
def create_expression(
    title: str, pub_date: str, source: Source, pages: int = None, man_types: list = None
):
    """
...
def create_person(person_data: dict, source: Source):
    """
...
def create_organisation(org_name: str, source: Source):
    """
...
def create_place(place_name: str, source: Source, place_type: str = None):
    """
    ...
    place, created = Place.objects.get_or_create(
        name=place_name,
        defaults={"source": source, "notes": place_type},
    )
